...
public class BitfinexApiCallbackListeners {
    ...
    protected final Queue<BiConsumer<BitfinexAccountSymbol, Collection<BitfinexFundingInfo>>> fundingEntryConsumers = new ConcurrentLinkedQueue<>();
    ...
    public Closeable onFundingEvent(final BiConsumer<BitfinexAccountSymbol, Collection<BitfinexFundingInfo>> listener) {
        fundingEntryConsumers.offer(listener);
        return () -> fundingEntryConsumers.remove(listener);
    }
